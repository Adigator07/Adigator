...
export default function TemplateRenderer({
  ...
  const renderSlot = (slotDef) => {
    ...
    return (
      <div 
        key={slotDef.id} 
        className="flex justify-center w-full my-4 overflow-hidden"
      >
        <motion.div
  ...
  return (
    <div className="flex justify-center w-full overflow-hidden bg-slate-100 py-8 rounded-2xl border border-white/10">
      <div
        ...
        <div className={`flex flex-1 ${isMobile ? 'flex-col px-4 py-6' : 'px-8 py-10 gap-10'} w-full max-w-[1200px] mx-auto`}>
          ...
          <main className="flex-1 flex flex-col min-w-0">
            ...
            <article className={`prose ${isMobile ? 'prose-sm' : 'prose-base md:prose-lg'} text-slate-700 max-w-none`}>
              ...
              {/* Interleaved Mobile Ads (If mobile, right slots map into content) */}
              ...
              <p className="mb-6">
                As these patterns become standardized, the tools we use to build them must also evolve. Static templates are being replaced by highly contextual, content-aware layout generators that adapt perfectly to the user's device and the specific content being rendered.
              </p>
            </article>
        ...
        <footer className="w-full bg-slate-950 text-slate-400 py-12 px-8 mt-auto border-t-[8px] border-blue-600">
          <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between gap-8">
            <div className="max-w-xs">
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-slate-800 hover:bg-blue-600 transition cursor-pointer"></div>
                <div className="w-8 h-8 rounded-full bg-slate-800 hover:bg-blue-600 transition cursor-pointer"></div>
                <div className="w-8 h-8 rounded-full bg-slate-800 hover:bg-blue-600 transition cursor-pointer"></div>
              </div>
            </div>
          ...
          <div className="max-w-[1200px] mx-auto mt-12 pt-8 border-t border-slate-800 text-xs text-center md:text-left">
            © 2026 The Daily Chronicle Media Group. All rights reserved.
          </div>
        </footer>
